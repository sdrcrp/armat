...
["TaskSucceeded", ["", "Press the button in your inventory to open Arma.Team menu"]]call BIS_fnc_showNotification;
};
...
asdasdhdsfglasdjhfuolh31f4674__main_player addAction["<t size=""1.1"" font=""RobotoCondensed"" color=""#A6A5A5"">Arma Team Scroll Menu</t>",{[]}];
